...
class DualTokenServerAuthenticationConverterTest {
    ...
    private final es.altia.domeadapter.backend.shared.infrastructure.security.DualTokenServerAuthenticationConverter converter =
            new es.altia.domeadapter.backend.shared.infrastructure.security.DualTokenServerAuthenticationConverter();
    ...
    void convert_withValidBearerAndIdToken_returnsDualTokenAuth() {
        ...
        StepVerifier.create(result)
                .assertNext(auth -> {
                    assertTrue(auth instanceof es.altia.domeadapter.backend.shared.infrastructure.security.DualTokenAuthentication);
                    es.altia.domeadapter.backend.shared.infrastructure.security.DualTokenAuthentication dual = (es.altia.domeadapter.backend.shared.infrastructure.security.DualTokenAuthentication) auth;

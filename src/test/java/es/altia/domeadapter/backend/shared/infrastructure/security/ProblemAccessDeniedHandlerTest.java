...
import es.altia.domeadapter.backend.shared.infrastructure.controller.error.ErrorResponseFactory;
...
class ProblemAccessDeniedHandlerTest {
    ...
    void handle_writesProblemJson_whenObjectMapperSucceeds() throws Exception {
        ...
        SecurityProblemResolver.ProblemSpec spec = new SecurityProblemResolver.ProblemSpec(
                "access.default",
                "Forbidden",

package es.altia.domeadapter.shared.infrastructure.config;

import es.altia.domeadapter.shared.infrastructure.config.adapter.ConfigAdapter;
import es.altia.domeadapter.shared.infrastructure.config.adapter.factory.ConfigAdapterFactory;
import es.altia.domeadapter.shared.infrastructure.config.properties.AppProperties;
import es.altia.domeadapter.shared.infrastructure.config.properties.CorsProperties;
import es.altia.domeadapter.shared.infrastructure.config.properties.IssuerIdentityProperties;
import es.altia.domeadapter.shared.infrastructure.config.properties.RetryProperties;

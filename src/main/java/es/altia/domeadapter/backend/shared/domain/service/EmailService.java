...
public interface EmailService {
    Mono<Void> sendResponseUriFailed(String to, String productSpecificationId, String credentialId, String providerEmail);
    Mono<Void> sendResponseUriExhausted(String to, String productSpecificationId, String credentialId, String providerEmail);

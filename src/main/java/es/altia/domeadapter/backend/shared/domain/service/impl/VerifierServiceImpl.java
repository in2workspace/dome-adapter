...
import es.altia.domeadapter.shared.domain.exception.JWTVerificationException;
import es.altia.domeadapter.shared.domain.exception.TokenFetchException;
import es.altia.domeadapter.shared.domain.exception.WellKnownInfoFetchException;
import es.altia.domeadapter.shared.domain.model.dto.OpenIDProviderMetadata;
import es.altia.domeadapter.shared.domain.model.dto.VerifierOauth2AccessToken;
import es.altia.domeadapter.shared.domain.service.VerifierService;
...
import static es.altia.domeadapter.shared.domain.util.Constants.CONTENT_TYPE;
import static es.altia.domeadapter.shared.domain.util.Constants.CONTENT_TYPE_URL_ENCODED_FORM;
import static es.altia.domeadapter.shared.domain.util.EndpointsConstants.AUTHORIZATION_SERVER_METADATA_WELL_KNOWN_PATH;

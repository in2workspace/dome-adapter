...
import static es.altia.domeadapter.shared.domain.util.EndpointsConstants.HEALTH_PATH;
import static es.altia.domeadapter.shared.domain.util.EndpointsConstants.ISSUANCES_PATH;
import static es.altia.domeadapter.shared.domain.util.EndpointsConstants.PROMETHEUS_PATH;
import static es.altia.domeadapter.shared.domain.util.EndpointsConstants.SPRINGDOC_PATH;

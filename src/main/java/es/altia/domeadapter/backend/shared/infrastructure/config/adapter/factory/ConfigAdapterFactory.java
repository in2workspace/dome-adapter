package es.altia.domeadapter.backend.shared.infrastructure.config.adapter.factory;

import es.altia.domeadapter.backend.shared.infrastructure.config.adapter.ConfigAdapter;
import es.altia.domeadapter.backend.shared.infrastructure.config.adapter.impl.YamlConfigAdapter;
